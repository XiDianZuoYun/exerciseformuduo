...
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/xiaodong/Qt/5.10.1/gcc_64/lib
...
distdir: FORCE
	...
	$(COPY_FILE) --parents POLLER.hpp Channel.hpp eventloop.hpp threadpool.hpp THREAD.h MUTEXLOCK.hpp CONDITION.hpp buffer.hpp Tcpsocket.h $(DISTDIR)/
	$(COPY_FILE) --parents POLLER.cpp eventloop.cpp Channel.cpp THREAD.cpp CONDITION.cpp MUTEXLOCK.cpp threadpool.cpp main.cpp buffer.cpp Tcpsocket.cpp $(DISTDIR)/
...
install_target: first FORCE
	...
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/usr/lib/$(QMAKE_TARGET)
