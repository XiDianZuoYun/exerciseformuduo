#############################################################################
# Makefile for building: libtest.so.1.0.0
# Generated by qmake (3.1) (Qt 5.10.1)
# Project:  test.pro
# Template: lib
# Command: /home/xiaodong/Qt/5.10.1/gcc_64/bin/qmake -o Makefile test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DTEST_LIBRARY -DQT_DEPRECATED_WARNINGS -DQT_QML_DEBUG -DQT_CORE_LIB
...
QMAKE         = /home/xiaodong/Qt/5.10.1/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/xiaodong/Qt/5.10.1/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/xiaodong/Qt/5.10.1/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
COMPRESS      = gzip -9f
DISTNAME      = test1.0.0
DISTDIR = /home/xiaodong/test/.tmp/test1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/xiaodong/Qt/5.10.1/gcc_64/lib -shared -Wl,-soname,libtest.so.1
LIBS          = $(SUBLIBS) -L/home/xiaodong/Qt/5.10.1/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
QMAKE_TARGET  = test
DESTDIR       = 
TARGET        = libtest.so.1.0.0
TARGETA       = libtest.a
TARGET0       = libtest.so
TARGETD       = libtest.so.1.0.0
TARGET1       = libtest.so.1
TARGET2       = libtest.so.1.0
...
Makefile: test.pro ../Qt/5.10.1/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt/5.10.1/gcc_64/mkspecs/common/unix.conf \
		../Qt/5.10.1/gcc_64/mkspecs/common/linux.conf \
		../Qt/5.10.1/gcc_64/mkspecs/common/sanitize.conf \
		../Qt/5.10.1/gcc_64/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents POLLER.hpp Channel.hpp eventloop.hpp threadpool.hpp THREAD.h MUTEXLOCK.hpp oopsocket.h CONDITION.hpp buffer.hpp $(DISTDIR)/
	$(COPY_FILE) --parents POLLER.cpp eventloop.cpp Channel.cpp THREAD.cpp CONDITION.cpp MUTEXLOCK.cpp threadpool.cpp oopsocket.cpp main.cpp buffer.cpp $(DISTDIR)/
...
moc_predefs.h: ../Qt/5.10.1/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -g -std=gnu++1y -Wall -W -dM -E -o moc_predefs.h ../Qt/5.10.1/gcc_64/mkspecs/features/data/dummy.cpp
...
POLLER.o: POLLER.cpp POLLER.hpp \
		MUTEXLOCK.hpp \
		Channel.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o POLLER.o POLLER.cpp

eventloop.o: eventloop.cpp eventloop.hpp \
		POLLER.hpp \
		MUTEXLOCK.hpp \
		Channel.hpp
...
CONDITION.o: CONDITION.cpp CONDITION.hpp \
		MUTEXLOCK.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o CONDITION.o CONDITION.cpp

MUTEXLOCK.o: MUTEXLOCK.cpp MUTEXLOCK.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MUTEXLOCK.o MUTEXLOCK.cpp
...
oopsocket.o: oopsocket.cpp oopsocket.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o oopsocket.o oopsocket.cpp
